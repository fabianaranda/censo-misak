...
<link type="text/css" rel="stylesheet" href="/css/form_ingreso_familia.css">
    ...
    <div class="pull-left breadcrumb_admin clear_both">
        <div class="pull-left page_title theme_color">
            <h1>Habitante</h1>
            <h2 class="">Informacion del Habiatente</h2>
        </div>
        <div class="pull-right">
            <ol class="breadcrumb">
                <li><a href="#">Inicio</a></li>
                <li><a href="#">Habitante</a></li>
                <li class="active">Informacion del Habiatente</li>
            </ol>
        </div>
    </div>
    <br>
    ...
    <div class="color_informacion_modulo " style="margin-top: 15px;">
        <span class="color_infor  ">Usted se encuentra en: &nbsp;&nbsp;<font color="#060505"> Sistema de Informacion
                Poblacional Misak -SIPEMP &gt; <font color="#060505">Habitante </font> &gt; <font color="#060505">
                Informacion del Habiatente</font> </span>
    </div>
            ...
            {{-- BOTON ACEPTAR --}}
                    <div class="row">
                        <div class="col-md-12">
                            <div class="pull-right">
                                ...
                                <button type="button" class="btn btn-success" style="background-color:#1b9e1d;color:white;""
                                          onclick="location.href='{{ url('/Informacion-Persona') }}'">Aceptar</button>
                            </div>
                        </div>
                    </div>
                    <br>
                ...
                <form id="formInfoPersonal" method="POST" enctype="multipart/form-data">
                    ...
                    {{-- Informacion del censo --}}
					 ...
					 <div class="contenedor_informacion_persona">
                        ...
                        <div class="col-md-4 form-group input-group-sm">
                            ...
                            class="form-control" required value="{{ $datos->nombres }}" disabled>
        
                        </div>
                        <div class="col-md-4 form-group input-group-sm">
                            <div class="etiqueta2 usuario">Apellido.(*)</div>
                            <input type="text" id="apellido" name="apellido" maxlength="50"
                                placeholder="Ingrese apellido" class="form-control" required value="{{ $datos->apellidos }}" disabled>
                        </div>
                        <div class="col-md-4 form-group input-group-sm">
                    ...
                    <div class="row">
                        <div class="col-md-4 form-group input-group-sm">
                            ...
                            <div>
                                <select id="tipo_identificacion" id="tipo_identificacion" name="tipo_identificacion" class="form-control" disabled disabled>
                                    <option value="">Seleccione</option>
                        ...
                        <div class="col-md-4 form-group input-group-sm">
                            ...
                            <input type="text" id="documento_persona" name="documento_persona" maxlength="30"
                                placeholder="Ingrese identificación" class="form-control" required value="{{ $datos->docomento_persona }}" disabled >
                        </div>
                        <div class="col-md-4 form-group input-group-sm">
                            <div class="etiqueta2">Fecha de nacimiento(*)</div>
                            <input type="date" id="fecha_nacimiento" name="fecha_nacimiento" placeholder="Ingrese fecha de nacimiento" class="form-control" required value="{{ $datos->fecha_nacimiento }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 form-group input-group-sm">
                            ...
                            <select id="parentesco" name="parentesco" class="form-control" required disabled>
                                <option value="">Seleccione</option>
                        ...
                        <div class="col-md-6 form-group input-group-sm">
                            ...
                            <select id="nivel_educativo" name="nivel_educativo" class="form-control" required disabled>
                                <option value="">Seleccione</option>
                        ...
                        <div class="recuadro_info_persona"> INFORMACION ACADEMICA DE: {{ $datos->nombres }}
                            {{ $datos->apellidos }} CC N° {{ $datos->docomento_persona }} </div>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                    {{-- Informacion de educación formal --}}
                    <div id="SiTieneEducacion">
                        <div class="recuadro_info_persona">INFORMACION DE EDUCACIÓN  </div>
                            ...
                            @foreach($vivienda as $key=>$temp)
                              
                            <div class="form-group input-group-sm">
                                    <label style="width:300px" for="title">Número Telefono :</label>
                         <input  name="telefono" placeholder="Teléfono" type="text"  value="{{$temp->nombre_municipio}}" class="form-control" disabled>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 form-group input-group-sm">
                                    ...
                                    <select name="nivel_academico" class=" form-control" id="ddNoEstudiaResguardo"
                                        onchange="showNoEstudiaResguardo(this);" autocomplete="of" disabled>
                                        <option value="">Seleccione</option>
                ...
                <div id="NoGustaQueEstudienGuambia" style="visibility: hidden; display: none;">
                    ...
                    <div class="contenedor_informacion_persona">
                        ...
                        <div class="recuadro_info_persona"> INFORMACION GENERAL DE: {{ $datos->nombres }}
                            {{ $datos->apellidos }} CC N° {{ $datos->docomento_persona }} </div>
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group input-group-sm">
                                    ...
                                    <select id="empresa_asociativa" name="empresa_asociativa" type="text" class="form-control" required disabled>
                                        <option value="">Seleccione</option>
                                ...
                                <div class="form-group input-group-sm">
                                    ...
                                    <select id="carnet_salud_id" name="carnet_salud_id" id="servicio_acueducto" class="form-control" required disabled>
                                ...
                                <div class="form-group input-group-sm">
                                    <label style="width:300px" for="title">Número Telefono :</label>
                                    <input id="telefono" name="telefono" placeholder="Teléfono" type="text" class="form-control" disabled>
                                </div>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group input-group-sm">
                                    ...
                                    <select id="religion" name="religion" type="text" class="form-control" required disabled>
                                        <option value="">Seleccione</option>
                                ...
                                <div class="form-group input-group-sm">
                                    ...
                                    <select id="enfemerma_recurre" name="enfemerma_recurre" type="text" class="form-control" required disabled>
                                        <option value="">Seleccione</option>
                                ...
                                <div class="form-group input-group-sm">
                                    ...
                                    <input id="comunidad_indigena" name="comunidad_indigena" placeholder="Comunidad" type="text" class="form-control" disabled>
                                </div>
                                                ...
                                                <div class="btn-group" data-toggle="buttons">
                                                    ...
                                                    <label class="btn btn-conocimiento" class="btn btn-info active"
                                                        ...
                                                        <input name="habla_namuy_wam" value="Entiende, pero no habla"
                                                            data-val="true"
                                                            data-val-required="El nivel de habilidad es un campo obligatorio"
                                                            required="" type="radio" aria-required="true" disabled>
                                                    ...
                                                    <label class="btn btn-conocimiento" class="btn btn-info active"
                                                        ...
                                                        <input name="habla_namuy_wam" value="Si Habla" data-val="true"
                                                            data-val-required="El nivel de habilidad es un campo obligatorio"
                                                            name="" required="" type="radio" aria-required="true" disabled>
                                                        Si Habla
                                                    </label>
                                                </div>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group input-group-sm">
                                    ...
                                    <select id="medico_tradicional" name="medico_tradicional" class="form-control" required disabled>
                                        <option value="">Seleccione</option>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group input-group-sm">
                                    ...
                                    <select id="conocimientos_empiricos" name="conocimientos_empiricos" class="form-control" required disabled>
                                        <option value="">Seleccione</option>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <div class="col-md-6 col-sm-12 col-xs-12">                           <!--Columna 1-->
                                <div class="form-group input-group-sm">
                                    ...
                                    <select id="deporte_constante" name="deporte_constante" class="form-control" required disabled>
                                        <option value="">Seleccione</option>
                                ...
                                <div class="form-group input-group-sm">
                                    <label f><span class="asterisco">*</span>¿Conoce lugares sagrados dentro del resguardo de
                                        Guambia?</label>
                                    <select id="lugares_sagrados" name="lugares_sagrados" class="form-control" required disabled> 
                                        <option value="">Seleccione</option>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group input-group-sm">
                                    ...
                                    <select id="juegos_tradicionales" name="juegos_tradicionales" class="form-control" required disabled>
                                        <option value="">Seleccione</option>
                                        <option value="Sí">Sí</option>
                                        <option value="No">No</option>
                                    </select>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group input-group-sm">
                                    <label f><span class="asterisco">*</span>¿Le realizan baños en las diferentes etapas de
                                        la vida? </label>
                                    <select id="baños_etapas_vida" name="baños_etapas_vida" class="form-control" required disabled>
                                        <option value="">Seleccione</option>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group input-group-sm">
                                    ...
                                    {{--<div id="Mujer">
                                        <div class="form-group input-group-sm">
                                            <label for="ddMujer"><span class="asterisco" disabled>*</span>¿Cuando llega la
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group input-group-sm">
                                    ...
                                    <select id="enfermedades_id" name="enfermedades_id" class="form-control" required disabled>
                                        <option value="">Seleccione</option>
                                ...
                                <div class="form-group input-group-sm">
                                    ...
                                    <select id="medicina_alternativa" name="medicina_alternativa" class="form-control" required disabled>
                                        <option value="">Seleccione</option>
                                        <option value="Ninguno">Ninguno </option>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group input-group-sm">
                                    ...
                                    <select id="consumo_sustancias" name="consumo_sustancias" class="form-control" required disabled>
                                        <option value="">Seleccione</option>
