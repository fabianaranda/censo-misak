...
<div class="pull-left breadcrumb_admin clear_both">
    <div class="pull-left page_title theme_color">
        <h1>Consulta Habiatente</h1>
        <h2 class=""></h2>
    </div>
    <div class="pull-right">
        <ol class="breadcrumb">
            <li><a href="#">Inicio</a></li>
            <li><a href="#">Consulta Habiatente</a></li>
            <li class="active"></li>
        </ol>
    </div>
</div>
...
<div class="color_informacion_modulo " style="margin-top: 15px;">
    <span class="color_infor  ">Usted se encuentra en: &nbsp;&nbsp;<font color="#060505"> Sistema de Informacion
            Poblacional Misak -SIPEMP &gt; <font color="#060505">Consulta Habiatente </font> &gt; <font color="#060505">
            </font> </span>
</div>
            ...
            <div class="col-md-4">
                  <div class="profile_bg">
                      ...
                      <div class="account-status-data" style="padding: 10px">
                          <h6>Ingresar documento de la persona a consultar</h6>
                    ...
                    <div class="block-web full">
                        <ul class="nav nav-tabs nav-justified nav_bg">
                            <li class="active"><a href="#Informacion_del_sistema" data-toggle="tab"><i
                                        class="fa fa-laptop"></i> Informacion del Habiatente</a></li>
                        </ul>
              ...
              success: (response) => {
                  ...
                  if(!response.status){
                          ...
                          let row = `<tr>
                                          ...
                                          <td><a href="/Informacion-Persona/${btoa(response.result.id)}">Ver Informacion</a></td>
                                      </tr>`;
