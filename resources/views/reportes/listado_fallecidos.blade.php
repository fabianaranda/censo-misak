...
<div class="pull-left breadcrumb_admin clear_both">
    <div class="pull-left page_title theme_color">
        <h1>Reporte</h1>
        <h2 class="">Listado de Personas Fallecidos</h2>
    </div>
    <div class="pull-right">
        <ol class="breadcrumb">
            <li><a href="#">Inicio</a></li>
            <li><a href="#">Reporte</a></li>
            <li class="active">Listado de Personas Fallecidos</li>
        </ol>
    </div>
</div>
...
<div class="color_informacion_modulo " style="margin-top: 15px;">
    <span class="color_infor  ">Usted se encuentra en: &nbsp;&nbsp;<font color="#060505"> Sistema de Informacion
            Poblacional Misak -SIPEMP &gt; <font color="#060505">Reportes </font> &gt; <font color="#060505">Listado de Personas Fallecidos</font> </span>
</div>
        ...
        <div class="ContenedorFormularioCenso">
            <div class="panel-body">
                <ul class="nav nav-tabs" id="myTab">
                    <li class="active"><a data-toggle="tab" href="#Tab1">Personas Fallecidos</a></li>
                        ...
                        <div class="col-md-12">
                            ...
                            BUSCAR POR CC: <input id="searchTerm" type="number" onkeyup="doSearch()" />
                                    ...
                                    <div class="table-responsive">
                                            ...
                                            <h4>Listado de personas fallecidos  en el resguado de Guambia.</h4>
