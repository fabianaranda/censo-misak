...
<body>
    ...
    <table id="vivienda" cellspacing="0" cellpadding="0">
        <thead>
            ...
            <tr class="sub-header">
                <th colspan="6">Información de la vivienda</th>
            </tr>
        </thead>
        <tbody>
            <tr>
                <td colspan="3" class="field">ID Vivienda:</td>
                <td colspan="3">{{ $vivienda->id }}</td>
            </tr>
            <tr>
                <td class="field">Departamento:</td>
                <td colspan="2">{{ $vivienda->nombre_depatamento }}</td>
                <td class="field">Municipio:</td>
                <td colspan="2">{{ $vivienda->nombre_municipio }}</td>
            </tr>
            <tr>
                <td class="field">Resguardo:</td>
                <td colspan="2">{{ $vivienda->nombre_reguardo }}</td>
                <td class="field">Zona:</td>
                <td colspan="2">{{ $vivienda->nombre_zona }}</td>
            </tr>
            <tr>
                <td class="field">Vereda:</td>
                <td colspan="2">{{ $vivienda->nombre_vereda }}</td>
                <td class="field">Sector:</td>
                <td colspan="2">{{ $vivienda->nombre_sector }}</td>
            </tr>
        </tbody>
    </table>
